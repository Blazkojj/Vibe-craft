...
try {
  ...
  const out = execSync(`ssh -i C:\\Users\\Blazkoj\\.ssh\\id_rsa -o StrictHostKeyChecking=no root@54.37.138.23 "grep -rn 'in_array' /var/www/pelican/app/ /var/www/pelican/resources/"`, { encoding: 'utf-8' });
